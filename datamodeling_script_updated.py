...
# The goal is to build a Random Forest model to predict rain on the following day using the prepared dataset
# that has already undergone data preparation steps.
...
print("The goal is to build a Random Forest model to predict rain on the following day using the prepared dataset")
print("that has already undergone data preparation steps including splitting and SMOTE for class imbalance.\n")
...
# Data Splitting (reproducing from data preparation phase)
print("\n## 4.1 Data Splitting (Reproduction from Data Preparation)")
print("As done in the data preparation phase, we split the data into training and testing sets to evaluate our model.")
print("This section reproduces the splitting process for completeness of the modeling workflow.\n")
...
print("Note: This step was performed in data preparation phase, but we demonstrate it here to show the process.\n")
